...
parser.add_argument('--addr', default=os.environ['OPENSHIFT_PYTHON_IP'], help='Address to listen on (default: all interfaces, both ipv4 and ipv6)')
parser.add_argument('--port', default=int(os.environ['OPENSHIFT_PYTHON_PORT']), type=int, help='Port to listen on')
